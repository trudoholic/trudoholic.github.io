...
/* harmony import */ var _js_Deck__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/Deck */ "./src/js/Deck.js");
/* harmony import */ var _js_Zone__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/Zone */ "./src/js/Zone.js");
/* harmony import */ var _js_ZoneX__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/ZoneX */ "./src/js/ZoneX.js");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (vue__WEBPACK_IMPORTED_MODULE_5__.default.extend({
  ...
  */
  computed: {
    ...
    */
    ...(0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapGetters)(["getMode"])
  },
  methods: {
    init() {
    //
      _js_state__WEBPACK_IMPORTED_MODULE_0__.state.zones[0] = new _js_Zone__WEBPACK_IMPORTED_MODULE_3__.default("cvs1");
      _js_state__WEBPACK_IMPORTED_MODULE_0__.state.zones[1] = new _js_Zone__WEBPACK_IMPORTED_MODULE_3__.default("cvs2");
      _js_state__WEBPACK_IMPORTED_MODULE_0__.state.zoneX = new _js_ZoneX__WEBPACK_IMPORTED_MODULE_4__.default("zxc");
      _js_state__WEBPACK_IMPORTED_MODULE_0__.state.deck = new _js_Deck__WEBPACK_IMPORTED_MODULE_2__.default(4);
      _js_state__WEBPACK_IMPORTED_MODULE_0__.state.update();
  
      document.getElementById("btn_0").onclick = () => {
        _js_state__WEBPACK_IMPORTED_MODULE_0__.state.deck.deselect();
      };
      document.getElementById("btn_add").onclick = () => {
        _js_state__WEBPACK_IMPORTED_MODULE_0__.state.deck.addCard();
      };
      document.getElementById("btn_add_3").onclick = () => {
        _js_state__WEBPACK_IMPORTED_MODULE_0__.state.deck.addGroup(3);
      };
      document.getElementById("btn_rem").onclick = () => {
        _js_state__WEBPACK_IMPORTED_MODULE_0__.state.deck.removeSelected();
      };
      
      let textlog = document.getElementById("log");
      _js_state__WEBPACK_IMPORTED_MODULE_0__.state.print = (t) => { textlog.append("> " + t + "\r\n") };
    //
    },
    ...(0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapActions)(["setMode"])
  },
  mounted: function(){
    console.log("mounted()");
    this.init();
    ...
    return _c("div", [
      _c(
        "canvas",
        {
          ...
          attrs: { id: "cvs1", width: "600", height: "400" }
        },
        [_vm._v("[No canvas support]")]
      ),
      _vm._v(" "),
      _c(
        "canvas",
        {
          staticClass: "zone",
          staticStyle: { float: "left", "margin-left": "100px" },
          attrs: { id: "cvs2", width: "600", height: "400" }
        },
        [_vm._v("[No canvas support]")]
      ),
      _vm._v(" "),
      _c(
        "canvas",
        {
          ...
          attrs: { id: "zxc", width: "600", height: "400" }
        },
        [_vm._v("[x]")]
      ),
      _vm._v(" "),
      _c("div", { attrs: { id: "buttons" } }, [
        _c("button", { attrs: { id: "btn_0" } }, [_vm._v("Сброс")]),
        _vm._v(" "),
        _c("button", { attrs: { id: "btn_add" } }, [_vm._v("Добавить")]),
        _vm._v(" "),
        _c("button", { attrs: { id: "btn_add_3" } }, [_vm._v("Добавить [3]")]),
        _vm._v(" "),
        _c("button", { attrs: { id: "btn_rem" } }, [_vm._v("Удалить")])
      ]),
      _vm._v(" "),
      _c("textarea", { attrs: { id: "log" } })
    ])
  }
]
...
class Card {
  constructor(i) {
    ...
    this.zone = _state__WEBPACK_IMPORTED_MODULE_0__.state.zones[0].id;
  ...
  load(i) {
    ...
    img.onload = () => {
      ...
      _state__WEBPACK_IMPORTED_MODULE_0__.state.print("Добавлена карта id = " + this.alt);
      _state__WEBPACK_IMPORTED_MODULE_0__.state.update();
    };
    img.src = this.src;
  }
...
class Deck {
  constructor(n) {
    this.items = [...Array(n)].map( (_, i) => new _Card__WEBPACK_IMPORTED_MODULE_1__.default(i) );
    this.count = this.items.length;
    console.log(this.items);
  }
  
  addCard() {
    this.items.push( new _Card__WEBPACK_IMPORTED_MODULE_1__.default(this.count ++) );
  }
  ...
  removeSelected() {
    this.selectedList().forEach(it => _state__WEBPACK_IMPORTED_MODULE_0__.state.print("Удалена карта id = " + it.alt));
...
const onMouseMove = e => {
  _state__WEBPACK_IMPORTED_MODULE_0__.state.zoneX.move(e.pageX - _state__WEBPACK_IMPORTED_MODULE_0__.state.offset.x, e.pageY - _state__WEBPACK_IMPORTED_MODULE_0__.state.offset.y);
  _state__WEBPACK_IMPORTED_MODULE_0__.state.zoneX.show();
};

const onMouseUp = e => {
  _state__WEBPACK_IMPORTED_MODULE_0__.state.drop = { x: e.pageX, y: e.pageY };
  
  document.removeEventListener('mousemove', onMouseMove);
  document.removeEventListener('mouseup', onMouseUp);
  
  _state__WEBPACK_IMPORTED_MODULE_0__.state.zoneX.hide();
  
  let delta = { x: (_state__WEBPACK_IMPORTED_MODULE_0__.state.drop.x - _state__WEBPACK_IMPORTED_MODULE_0__.state.offset.x), y: (_state__WEBPACK_IMPORTED_MODULE_0__.state.drop.y - _state__WEBPACK_IMPORTED_MODULE_0__.state.offset.y) };
  _state__WEBPACK_IMPORTED_MODULE_0__.state.offset = null;
  
  let zone = null;
  let list = _state__WEBPACK_IMPORTED_MODULE_0__.state.zones.filter(it => it.contains(_state__WEBPACK_IMPORTED_MODULE_0__.state.drop.x, _state__WEBPACK_IMPORTED_MODULE_0__.state.drop.y));
  ...
  if (zone) {
    ...
    _state__WEBPACK_IMPORTED_MODULE_0__.state.deck.selectedList()
    .forEach(it => it.move(delta));
  }
  else {
    _state__WEBPACK_IMPORTED_MODULE_0__.state.deck.allList().forEach(it => it.deselect());
  }
  _state__WEBPACK_IMPORTED_MODULE_0__.state.update();
}

class Zone extends _Base__WEBPACK_IMPORTED_MODULE_1__.default {
  constructor(id) {
    super(id);
  ...
  get hasSelected() {
    return _state__WEBPACK_IMPORTED_MODULE_0__.state.deck.zoneSelectedList(this.id).length > 0;
  }
  
  redraw() {
    super.redraw();
    _state__WEBPACK_IMPORTED_MODULE_0__.state.deck.zoneList(this.id).forEach(it => this.draw(it));
  }
  ...
  onClickHandler(e) {
    ...
    _state__WEBPACK_IMPORTED_MODULE_0__.state.deck.notZoneList(this.id).forEach(it => it.deselect());
    _state__WEBPACK_IMPORTED_MODULE_0__.state.update();
    
    let list = _state__WEBPACK_IMPORTED_MODULE_0__.state.deck.zoneContainsList(this.id, e.offsetX, e.offsetY);
    if (list.length) {
      list[0].toggle();
      this.redraw();
    }
  ...
  onMouseDownHandler(e) {
    ...
    if (! _state__WEBPACK_IMPORTED_MODULE_0__.state.offset) _state__WEBPACK_IMPORTED_MODULE_0__.state.offset = { x: e.offsetX, y: e.offsetY };
    
    this.timerId = setTimeout(() => {
      _state__WEBPACK_IMPORTED_MODULE_0__.state.zoneX.redraw(this.id);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ZoneX)
/* harmony export */ });
/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./state */ "./src/js/state.js");
/* harmony import */ var _Base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Base */ "./src/js/Base.js");
...
class ZoneX extends _Base__WEBPACK_IMPORTED_MODULE_1__.default {
  constructor(id) {
    super(id);
  }
  ...
  redraw(id) {
    super.redraw();
    _state__WEBPACK_IMPORTED_MODULE_0__.state.deck.zoneSelectedList(id)
